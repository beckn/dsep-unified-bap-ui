...
import { useTheme, userSkillView } from '@context';
...
function HomeScreen({ navigation }: { navigation: Navigation }) {
  ...
  const containerStyle = { height: 'auto', backgroundColor: 'white', position: 'absolute', borderRadius: 10, bottom: 0, width: '100%', paddingHorizontal:'10%' };
  const ScholarcontainerStyle = { paddingHorizontal: 24, backgroundColor: 'white', position: 'absolute', borderRadius: 10, bottom: 0, alignItems: 'center', height: 500, width: 400 };
  return (
    <View style={styles.container}>
      ...
      {(selectedCatagory === 'Jobs & Internships') ? (
        ...
        (
          ...
          (
            <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={[containerStyle, { paddingHorizontal: 24 }]}>
